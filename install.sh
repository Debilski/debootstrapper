...
wget -O "$TARGET/root/puppetlabs-release-pc1-jessie.deb" https://apt.puppetlabs.com/puppet5-release-jessie.deb
systemd-nspawn -D "$TARGET" dpkg -i /root/puppet5-release-jessie.deb
